    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluator', models.CharField(choices=[('Naresh Kumar', 'Naresh Kumar')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.CharField(choices=[('Naresh Kumar', 'Naresh Kumar')], max_length=200, null=True)),
                ...
                ('group', models.CharField(choices=[('member', 'member'), ('administrator', 'administrator')], max_length=200, null=True)),
