    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(choices=[('Cyber Security', 'Cyber Security'), ('Artificial Intelligence', 'Artificial Intelligence'), ('Data Science', 'Data Science'), ('Competitive Programming', 'Competitive Programming'), ('Hackathons', 'Hackathons'), ('Open Source', 'Open Source')], max_length=100, null=True)),
                ...
                ('reviewer', models.CharField(choices=[], max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
